...
//        btnEdit=container.findViewById(R.id.btnEdit);
//        tvDesc=container.findViewById(R.id.tvDesc);
//        btnEdit.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                tvDesc.setText("This is the text from the fragment...");
//
//            }
//        });
        Button btnEdit;
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btnEdit.setText("Edited");
                tvDesc.setText("Text is edited by a fragment");
            }
        });
        return view;
    }
